...
const stateColors: Record<LetterState | 'unused', string> = {
  correct: 'bg-pink-400 text-white',
  present: 'bg-violet-400 text-white',
  absent: 'bg-gray-300 text-gray-500',
  empty: 'bg-pink-100 text-gray-700',
  revealed: 'bg-gray-200 text-gray-400',
  hinted: 'bg-gray-200 text-gray-400',
  unused: 'bg-pink-100 text-gray-700',
}
            ...
            return (
              <button
                ...
                className={`
                  ...
                  h-12 sm:h-14 rounded-lg font-bold uppercase
